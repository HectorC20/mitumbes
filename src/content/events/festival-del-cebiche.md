---
title:
  es: "Festival del Cebiche de Tumbes"
  en: "Tumbes Ceviche Festival"
  pt: "Festival do Cebiche de Tumbes"
description:
  es: "Celebración gastronómica en honor al cebiche: degustaciones, concursos del mejor cebiche tumbesino, música en vivo y ferias de artesanía."
  en: "Gastronomic celebration in honor of ceviche: tastings, contests for the best Tumbes-style ceviche, live music and craft fairs."
  pt: "Celebração gastronômica em homenagem ao cebiche: degustações, concursos do melhor cebiche tumbesino, música ao vivo e feiras de artesanato."
excerpt:
...
activities:
  es:
    ...
    - "Asistir a concursos gastronómicos"
    - "Disfrutar de la música en vivo"
  en:
    - "Tasting ceviche from different cevicherías"
    - "Attending gastronomic contests"
    - "Enjoying the live music"
  pt:
    - "Degustar cebiches de diferentes cevicherias"
    - "Participar de concursos gastronômicos"
    - "Aproveitar a música ao vivo"
source:
  es: "Ficha preliminar MiTumbes — evento de muestra, fechas a confirmar con el ente organizador."
  en: "Preliminary MiTumbes record — sample event, dates to be confirmed with the organizing body."
  pt: "Ficha preliminar MiTumbes — evento de amostra, datas a confirmar com o órgão organizador."
verified: false
featured: false
rating: 4.4
